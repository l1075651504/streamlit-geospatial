...
class MultiApp:
    ...
    def run(self):
        ...
        st.sidebar.info(
            ...
            "[issues](https://github.com/l1075651504/streamlit-geospatial/issues) or "
            "[pull requests](https://github.com/l1075651504/streamlit-geospatial/pulls) "
            "to the [source code](https://github.com/l1075651504/streamlit-geospatial). "
        )
